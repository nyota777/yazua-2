...
export function AboutSection() {
  const specialties = [
    ...
    { icon: Lightbulb, label: 'Entrepreneurial Training' },
    { icon: Brain, label: 'Masculinity Expertise' },
    { icon: Mountain, label: 'Experiential Learning' },
    { icon: Award, label: 'Rites of Passage' },
    { icon: BookOpen, label: 'Design Thinking' },
    { icon: Users, label: 'Mentorship' },
    { icon: Heart, label: 'Coaching' },
  ];

  const milestones = [
    { year: '2008', title: 'Founded', description: 'Established in Nairobi, Kenya' },
    { year: '2012', title: 'First Camp', description: 'Launched outdoor adventure programs' },
    { year: '2015', title: '250 Boys', description: 'Reached 250 mentored youth' },
    { year: '2020', title: 'Expansion', description: 'Expanded programs nationwide' },
    { year: '2026', title: '500+ Boys', description: 'Over 500 young leaders trained' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Using experiential development models, we prepare young men for leadership
            and a life of positive impact through mentorship, project-based learning, and
            outdoor adventure camps. We believe in transforming boys into confident,
            capable leaders who will shape the future of our communities.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1640951332580-1072ff909952?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvdXRkb29yJTIwYWR2ZW50dXJlJTIwY2FtcHxlbnwxfHx8fDE3Njc5NjE0MjV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
              alt="Outdoor Camps"
              className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1732539539294-4cc2f38fac9e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbnRyZXByZW5ldXJzaGlwJTIwd29ya3Nob3B8ZW58MXx8fHwxNzY3OTYxNDI2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
              alt="Workshops"
              className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
              <div>
                <h3 className="text-white text-2xl font-bold mb-2">Project Workshops</h3>
